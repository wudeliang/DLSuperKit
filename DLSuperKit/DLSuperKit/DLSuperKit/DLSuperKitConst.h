...
#ifndef DLSuperKitConst_h
#define DLSuperKitConst_h
 ...
 */
#ifndef TFLog
#  define DLLog(fmt, ...) NSLog((@"function:%s,line:%d" fmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__);
#endif



#endif /* DLSuperKitConst_h */
