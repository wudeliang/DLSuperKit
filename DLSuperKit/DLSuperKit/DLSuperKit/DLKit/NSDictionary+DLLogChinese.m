...
#import "NSDictionary+DLLogChinese.h"
#import <objc/runtime.h>
#import "DLSuperKitConfigue.h"
@implementation NSDictionary (DLLogChinese)

+(void)load{
    if ([DLSuperKitConfigue shareInstance].DLDebug_NSDictionaryLogChinese) {
